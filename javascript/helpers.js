 ...
 */
function PointIntersect(elemAPointA, elemBPointA, elemAPointB, elemBPointB) {
    if ((elemAPointA.y <= elemBPointA.y && elemBPointA.y <= elemAPointB.y ||
        elemAPointA.y <= elemBPointB.y && elemBPointB.y <= elemAPointB.y ||
        elemBPointA.y <= elemAPointA.y && elemAPointA.y <= elemBPointB.y ||
        elemBPointA.y <= elemAPointB.y && elemAPointB.y <= elemBPointB.y) &&
